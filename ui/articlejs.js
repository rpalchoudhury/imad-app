    ...
    request.onreadystatechange=function(){
        ...
        if(request.readyState==XMLHttpRequest.DONE)
        {
            if(request.status==200)
            {
                ...
                if(commentList.textContent.toString()=="Can't display comments..database getting updated...regret inconvenience caused.."||commentList.textContent.toString()=="No comments exist for this article yet...")
